...
const Bio = () => {
  ...
  return (
    <div className="flex pt-16 pb-24">
      ...
      />
      <p>
        Written by <strong>Lars Karbo</strong> - An indie hacker currently
        working his way through his{" "}
        <Link className="underline text-blue-800" to="/12-startups-12-months/">
          12 startups in 12 months
        </Link>{" "}
        project. Sharing insights from the journey.
      </p>
    </div>
  )
}
