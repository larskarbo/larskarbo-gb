...
module.exports = (
  ...
  const generateImagesAndUpdateNode = async function (
    ...
    // lars options
    const small = overWrites.small
    const leftAligned = small
    ...
    const args = small ? {  ...options, maxWidth: 300 } : options
  ...
  >
    ...
    <span
      ...
      style="position: relative; display: block; ${leftAligned ? "" : "margin-left: auto; margin-right: auto;"} max-width: ${presentationWidth}px; ${
            ...
            for (let thisImg of imageRefs) {
              ...
              if (
                ...
                const rawHTML = await generateImagesAndUpdateNode(
                  ...
                  inLink,
                  {
                    small: typeof thisImg.attr(`small`) != "undefined"
                  }
                )
